        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-md-50">Book Property</h4>
                        ...
                        <form class="w-100" action="#" method="post">
									<div class="row">
										<div class="row mb-4">
											...
											<div class="form-group col-lg-6">
												<input type="text" name="subject"  class="form-control" placeholder="Duration in Months">
											</div>
											<div class="col-lg-12">
										...
										<button type="submit" value="send message" name="send" class="btn btn-success">Book property</button>
									</div>
								</form>
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Total Payment Calculator</h4>
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="interest" placeholder="Agent Percentage Rate">
                            </div>
                            <button type="submit" value="submit" name="calc" class="btn btn-danger mt-4">Calclute Payment</button>
                        </form>
