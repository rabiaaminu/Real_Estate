                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Unlock the potential of your property with our comprehensive selling services. From strategic marketing to expert negotiation, we're dedicated to maximizing your returns and simplifying the selling process. Trust us to showcase your property and attract the perfect buyer.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Unlock the perfect rental experience with our comprehensive rental services. From cozy apartments to luxurious estates, we offer tailored solutions to match your lifestyle needs. Let us guide you to your ideal rental property, where comfort meets convenience.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Here, you'll find a diverse range of homes, apartments, and commercial spaces tailored to your needs. Browse through our curated selection and unlock the door to your dream property.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Rest assured with our real estate management system, where legality meets opportunity. Seamlessly navigate the legal intricacies of property investment with confidence and peace of mind, ensuring every transaction is secure and compliant.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Ranked as a top performer in the realm of real estate management systems, our platform stands as a beacon of excellence. With unparalleled service and cutting-edge technology, we redefine industry standards, ensuring your property needs are met with utmost proficiency and satisfaction.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Experience the hallmark of excellence with our Real Estate Management System. With a proven track record of delivering quality service, we ensure your property needs are met with unparalleled expertise and reliability.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team comprises seasoned agents with years of industry experience. Trust in our expertise to guide you through every step of your property journey, ensuring success and satisfaction at every turn</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>We prioritize meaningful discussions. Whether it's strategizing your property goals or negotiating deals, our platform fosters collaborative dialogue to ensure your needs are met and surpassed.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Meticulous file reviews are conducted with precision and care. Ensuring every document meets stringent standards, we guarantee transparency and reliability in every transaction.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Acquire properties that meet the highest standards of quality, value, and potential.</p>
                        </div>
                    </div>
                </div>
            </div>
